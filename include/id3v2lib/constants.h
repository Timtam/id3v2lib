...
#define TITLE_FRAME_ID(x) DECIDE_FRAME(x, "TT2", "TIT2")
#define ARTIST_FRAME_ID(x) DECIDE_FRAME(x, "TP1", "TPE1")
#define ALBUM_FRAME_ID(x) DECIDE_FRAME(x, "TAL", "TALB")
#define ALBUM_ARTIST_FRAME_ID(x) DECIDE_FRAME(x, "TP2", "TPE2")
#define GENRE_FRAME_ID(x) DECIDE_FRAME(x, "TCO", "TCON")
#define TRACK_FRAME_ID(x) DECIDE_FRAME(x, "TRK", "TRCK")
#define YEAR_FRAME_ID(x) DECIDE_FRAME(x, "TYE", "TYER")
#define COMMENT_FRAME_ID(x) DECIDE_FRAME(x, "COM", "COMM")
#define DISC_NUMBER_FRAME_ID(x) DECIDE_FRAME(x, "TPA", "TPOS")
#define COMPOSER_FRAME_ID(x) DECIDE_FRAME(x, "TCM", "TCOM")
#define ALBUM_COVER_FRAME_ID(x) DECIDE_FRAME(x, "PIC", "APIC")
// END FRAME IDs
