...
#define ID3V2_ALBUM_ARTIST_FRAME_ID(x) ID3V2_DECIDE_FRAME(x, "TP2", "TPE2")
#define ID3V2_GENRE_FRAME_ID(x) ID3V2_DECIDE_FRAME(x, "TCO", "TCON")
#define ID3V2_TRACK_FRAME_ID(x) ID3V2_DECIDE_FRAME(x, "TRK", "TRCK")
#define ID3V2_YEAR_FRAME_ID(x) ID3V2_DECIDE_FRAME(x, "TYE", "TYER")
#define ID3V2_COMMENT_FRAME_ID(x) ID3V2_DECIDE_FRAME(x, "COM", "COMM")
#define ID3V2_DISC_NUMBER_FRAME_ID(x) ID3V2_DECIDE_FRAME(x, "TPA", "TPOS")
#define ID3V2_COMPOSER_FRAME_ID(x) ID3V2_DECIDE_FRAME(x, "TCM", "TCOM")
#define ID3V2_ALBUM_COVER_FRAME_ID(x) ID3V2_DECIDE_FRAME(x, "PIC", "APIC")
// END FRAME IDs
...
#define ID3V2_JPG_MIME_TYPE "image/jpeg"
#define ID3V2_PNG_MIME_TYPE "image/png"
